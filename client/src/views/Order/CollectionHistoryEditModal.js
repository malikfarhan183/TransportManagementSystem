...
class CollectionHistoryEditModal extends React.Component {
...
this.setState({date:this.h1[0]})
  ...
  render() {
    console.log("render of modal" , this.props.id);

    return (
      <div >

        <Modal style={{marginLeft:'33%' , marginTop:'9%'}}isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
          <ModalHeader toggle={this.toggle}><h4>Edit Collection</h4></ModalHeader>
          <ModalBody>
...
<FormGroup>
  ...
  <Input style={{width:'190px'}}onChange={this.onChangeForm}type="email" name="name" id="exampleEmail" placeholder="Enter Name" />
</FormGroup>
<FormGroup>
<Label for="exampleSelect">Payment Mode</Label>
<Input style={{width:'190px'}} onChange={this.onChangeForm}  type="select" name="paymentMode" id="exampleSelect">
...
<FormGroup>
  ...
  <Input  onChange={this.onChangeForm}  type="text" name="amount" id="exampleEmail" placeholder="Enter Amount" />
</FormGroup>
<FormGroup>
  <Label for="orderdate">Payment Date</Label>
  <Input  onChange={this.onChangeForm}  type="Date" value={this.state.date} name="paymentDate" id="deliverydate" placeholder="Choose a Date" />
</FormGroup>
</div>
{/*<div style={{display:'flex'}}>
...
export default CollectionHistoryEditModal;
